...
<title>Email</title>
    <link rel="stylesheet" href="ManagerView Email.css" />
...
<!-- The sidebar -->
<div class="sidebar">
    <a href="ManagerView.html"><i class="fa fa-fw fa-home"></i> Home</a>
    ...
    <a class="active" href="ManagerView Email.html"><i class="fa fa-fw fa-envelope"></i> Email</a>
